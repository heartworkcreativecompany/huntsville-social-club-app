  ...
  return (
    ...
    >
      <div
        ...
        className="mx-auto grid max-w-6xl grid-cols-[44px_minmax(0,1fr)_44px] items-center py-4 pt-[max(1rem,env(safe-area-inset-top))] pl-[max(1.25rem,env(safe-area-inset-left))] pr-[max(1.25rem,env(safe-area-inset-right))] sm:pl-[max(2rem,env(safe-area-inset-left))] sm:pr-[max(2rem,env(safe-area-inset-right))] lg:flex lg:items-center lg:justify-between lg:gap-3"
      >
        <div className="col-start-2 row-start-1 flex min-w-0 justify-center lg:flex-1 lg:items-center lg:justify-start lg:gap-6">
        ...
        <div className="col-start-1 row-start-1 flex h-11 w-11 items-center justify-center overflow-visible lg:ml-auto lg:h-auto lg:w-auto lg:shrink-0 lg:gap-1">
          <NotificationsBell
            items={notifications}
        ...
        <button
          ref={toggleRef}
          type="button"
          className="col-start-3 row-start-1 inline-flex h-11 w-11 min-h-11 min-w-11 items-center justify-center rounded-full text-accent transition hover:bg-accent-soft focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/40 focus-visible:ring-offset-2 focus-visible:ring-offset-surface lg:hidden"
